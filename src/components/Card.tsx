...
export const Card = ({ id, date, hour, city, name, phone }: IRide) => {
  return (
    <li className="flex flex-col shadow-default border border-border rounded-xl p-5 bg-container-bg  gap-3" key={id}>
